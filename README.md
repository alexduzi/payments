...
Clone the repo:
```sh
git clone git@github.com:alexduzi/payments.git or git clone https://github.com/alexduzi/payments.git
cd payments
```
...
# Run docker
docker run -p 4040:4040 payments
```
